...
async function testEmptyTestCases(assessmentId) {
    console.log(`Testing empty test cases for assessment: ${assessmentId}`);
    ...
    try {
        ...
        // Test 3: Process questions and check for test cases
        console.log('\n=== TEST 3: Processing Questions and Test Cases ===');
        let allQuestions = [];
                    ...
                    for (const question of batchItem.questions) {
                        ...
                        if (question.entityType === 'coding') {
                            ...
                            if (question.testCases) {
                                ...
                                console.log('  No test cases found - this is OK');
                                console.log('  Creating empty test cases array');
